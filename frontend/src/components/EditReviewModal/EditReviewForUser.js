...
export default function EditUserReviews ({reviewId, editSpotId}) {
    ...
    return (
        <ReviewForm currentReview={userReview} closeModal={closeModal} reviewType="edit" editSpotId={editSpotId} />
    )
}
